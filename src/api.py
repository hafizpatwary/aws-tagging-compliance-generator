...
def generate_policy(resource, actions, max_char_count=6144 ,return_json=False):
    ...
    max_action_char = max_char_count - estimated_json - 100
...
def main():
    ...
    if page_response:
        ...
        policies = generate_policy('all', service_actions_filtered, return_json=False)
        for index, policy in enumerate(policies):
            create_policy_file(index, policy)
        # print(service_actions_filtered)
        ...
        #         create_policy_file(resource, policy)
